...
def show_rules():
    ...
    3. For each correct answer, the points are allotted as: Easy-100, Moderate-300, Difficult-500.
    '''
...
def start_game_2():
    ...
    def show_question_2():
        question_label_2.config(text=hard_2[randomno_2[question_number_2]], bg='#062844', fg="white",
                                ...
                                highlightthickness=2,wraplength=700)
    ...
    def show_result_2():
        question_label_2.config(text="Your score is: " + str(score_2), width=15,height=2,font=("Arial", 15, "bold"))
        option_btn1_2.config(text="")
        option_btn2_2.config(text="")
        option_btn3_2.config(text="")
        option_btn4_2.config(text="")
        result_btn_3 = Button(root_2, text='EXIT', command=exit)
        result_btn_3.config(fg='black', bg='#126EC4', height=4, width=12, font=("Arial", 20, "bold"))
        result_btn_3.place(relx=0.5, rely=0.3, anchor='center')
...
def start_game_1():
    global bg_image,score_final
    
    root_1 = Toplevel(main)
    root_1.title("Moderate")
    ...
    bg_label_1 = Label(root_1, image=bg_image)
    ...
    def show_result_1():
        question_label_1.config(text="Your score is: " + str(score_1), width=15,height=2,font=("Arial", 15, "bold"))
        option_btn1_1.config(text="")
        option_btn2_1.config(text="")
        option_btn3_1.config(text="")
        option_btn4_1.config(text="")
        result_btn_2 = Button(root_1, text='NEXT', command=new_window1)
        result_btn_2.config(fg='black', bg='light blue', height=4, width=7, font=("Arial", 15, "bold"))
        result_btn_2.place(relx=0.5, rely=0.3, anchor='center')
...
def start_game():
    ...
    def show_result():
        question_label.config(text="Your score is: " + str(score), width=15,height=2,font=("Arial", 15, "bold") )
        ...
        result_btn.config(fg='black', bg='light blue', height=4, width=15, font=("Arial", 15, "bold"))
        result_btn.place(relx=0.5, rely=0.3, anchor='center')
